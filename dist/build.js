...
},{"timers":6}],8:[function(require,module,exports){
...
},{"./vue.runtime.common.dev.js":7,"./vue.runtime.common.prod.js":9,"_process":5}],9:[function(require,module,exports){
(function (global,setImmediate){(function (){
/*!
 * Vue.js v2.6.12
 * (c) 2014-2020 Evan You
...
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"app"},[_c('editor')],1)}
...
if (module.hot) {(function () {  var hotAPI = require("vueify/node_modules/vue-hot-reload-api")
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-566e0e1e", __vue__options__)
  } else {
    hotAPI.reload("data-v-566e0e1e", __vue__options__)
  }
})()}
},{"./components/Editor.vue":13,"vue":8,"vueify/lib/insert-css":10,"vueify/node_modules/vue-hot-reload-api":11}],13:[function(require,module,exports){
...
var _TextField = require("./TextField.vue");
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"editor"},[_c('h1',[_vm._v(_vm._s(_vm.msg))]),_vm._v(" "),_c('text-field'),_vm._v(" "),_c('text-field')],1)}
__vue__options__.staticRenderFns = []
if (module.hot) {(function () {  var hotAPI = require("vueify/node_modules/vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  ...
  module.hot.dispose(__vueify_style_dispose__)
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-4da46750", __vue__options__)
  } else {
    hotAPI.reload("data-v-4da46750", __vue__options__)
  }
})()}
},{"./TextField.vue":14,"interactjs":2,"vue":8,"vueify/lib/insert-css":10,"vueify/node_modules/vue-hot-reload-api":11}],14:[function(require,module,exports){
var __vueify_style_dispose__ = require("vueify/lib/insert-css").insert("*[data-v-21d18b8c] {\n  box-sizing: border-box;\n}\n\n.chord[data-v-21d18b8c] {\n  background-color: transparent;\n  color: #121212;\n  position: absolute;\n  height: 30px;\n  width: 300px;\n  user-select: none;\n  display: flex;\n  flex-flow: row wrap;\n}\n\n.chord > div[data-v-21d18b8c]  {\n  display: block;\n  flex: 1 1 100%;\n  width: 100%;\n  height: 30px;\n  line-height: 30px;\n  background: transparent;\n  border: 1px solid rgba(0,0,0,.1);\n  margin: 0;\n  font-family: \"Steps Mono\", \"Courier New\", monospace;\n}\n\n.chord .configView[data-v-21d18b8c] {\n  flex: 1 1 100%;\n  display: flex;\n  position: absolute;\n  top: -30px;\n  justify-content: center;\n  align-items: center;\n  flex-flow: row wrap;\n}\n\n.chord .configView textarea[data-v-21d18b8c] {\n  resize: none;\n  overflow-y: auto;\n  flex: 1 1 100%;\n}\n\n.bold[data-v-21d18b8c] {\n  font-weight: 800;\n}\n\n.italic[data-v-21d18b8c] {\n  font-style: italic;\n}\n\n.centered[data-v-21d18b8c] {\n  text-align: center;\n}\n\n.left[data-v-21d18b8c] {\n  text-align: left;\n}\n\n.right[data-v-21d18b8c] {\n  text-align: right;\n}")
;(function(){
'use strict';
...
exports.default = {
  ...
  data: function data() {
    return {
      content: "",
      mdcontent: "",
      id: (0, _lodash2.default)('text-field-'),
      isBold: false,
      isItalic: false,
      inEdit: false,
      textAlignment: "Left",
  ...
  mounted: function mounted() {
    var draggableWrapper = this.$refs.draggableWrapper;
  ...
  methods: {
    initInteract: function initInteract(selector) {
      (0, _interactjs2.default)(selector).draggable({
        inertia: false,
        restrict: {
          restriction: "parent",
          endOnly: true,
    ...
    adjustParentSize: function adjustParentSize(childElement, parentContainer) {
    ...
    heightListener: function heightListener(event) {
      var textInput = this.$refs.textInput;
      var rawInput = this.$refs.rawInput;
    ...
    dragScaleListener: function dragScaleListener(event) {
      if (!this.inEdit) {
        var target = event.target,
    ...
    openConfig: function openConfig(event) {
      this.inEdit = true;
    },
    closeConfig: function closeConfig(event) {
      this.inEdit = false;
      this.mdcontent = _dompurify2.default.sanitize(_marked.marked.parse(this.content));
...
var __vue__options__ = (typeof module.exports === "function"? module.exports.options: module.exports)
if (__vue__options__.functional) {console.error("[vueify] functional components are not supported and should be defined in plain js files using render functions.")}
__vue__options__.render = function render () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{directives:[{name:"click-outside",rawName:"v-click-outside",value:(_vm.closeConfig),expression:"closeConfig"}],ref:"draggableWrapper",staticClass:"chord"},[_c('div',{ref:"textInput",class:[{ bold: _vm.isBold }, { italic: _vm.isItalic }, _vm.textAlignment],attrs:{"type":"text","id":_vm.id,"value":"mdcontent"},domProps:{"innerHTML":_vm._s(_vm.mdcontent)}}),_vm._v(" "),(_vm.inEdit)?_c('div',{staticClass:"configView"},[_c('button',{attrs:{"type":"button","id":_vm.id},on:{"click":function($event){_vm.isBold = !_vm.isBold}}},[_vm._v("\r\n      Bold\r\n    ")]),_vm._v(" "),_c('button',{attrs:{"type":"button","id":_vm.id},on:{"click":function($event){_vm.isItalic = !_vm.isItalic}}},[_vm._v("\r\n      Italic\r\n    ")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.textAlignment),expression:"textAlignment"}],attrs:{"type":"radio","id":"left","value":"left"},domProps:{"checked":_vm._q(_vm.textAlignment,"left")},on:{"change":function($event){_vm.textAlignment="left"}}}),_vm._v(" "),_c('label',{attrs:{"for":"left"}},[_vm._v("Left")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.textAlignment),expression:"textAlignment"}],attrs:{"type":"radio","id":"center","value":"centered"},domProps:{"checked":_vm._q(_vm.textAlignment,"centered")},on:{"change":function($event){_vm.textAlignment="centered"}}}),_vm._v(" "),_c('label',{attrs:{"for":"center"}},[_vm._v("Center")]),_vm._v(" "),_c('input',{directives:[{name:"model",rawName:"v-model",value:(_vm.textAlignment),expression:"textAlignment"}],attrs:{"type":"radio","id":"right","value":"right"},domProps:{"checked":_vm._q(_vm.textAlignment,"right")},on:{"change":function($event){_vm.textAlignment="right"}}}),_vm._v(" "),_c('label',{attrs:{"for":"right"}},[_vm._v("Right")]),_vm._v(" "),_c('textarea',{directives:[{name:"model",rawName:"v-model",value:(_vm.content),expression:"content"}],ref:"rawInput",class:[{ bold: _vm.isBold }, { italic: _vm.isItalic }, _vm.textAlignment],attrs:{"type":"text","id":_vm.id,"value":"content","rows":"10"},domProps:{"value":(_vm.content)},on:{"input":function($event){if($event.target.composing){ return; }_vm.content=$event.target.value}}},[_vm._v("\r\n      "+_vm._s(_vm.content)+"\r\n    ")])]):_vm._e()])}
__vue__options__.staticRenderFns = []
__vue__options__._scopeId = "data-v-21d18b8c"
if (module.hot) {(function () {  var hotAPI = require("vueify/node_modules/vue-hot-reload-api")
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  module.hot.accept()
  module.hot.dispose(__vueify_style_dispose__)
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-21d18b8c", __vue__options__)
  } else {
    hotAPI.reload("data-v-21d18b8c", __vue__options__)
  }
})()}
},{"dompurify":1,"interactjs":2,"lodash.uniqueid":3,"marked":4,"vue":8,"vueify/lib/insert-css":10,"vueify/node_modules/vue-hot-reload-api":11}],15:[function(require,module,exports){
var Vue = require("vue");
